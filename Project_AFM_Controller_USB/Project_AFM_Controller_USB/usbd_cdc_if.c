...
static int8_t Project_AFM_Controller_USB_Init     (void);
static int8_t Project_AFM_Controller_USB_DeInit   (void);
static int8_t Project_AFM_Controller_USB_Control  (uint8_t cmd, uint8_t* pbuf, uint16_t length);
static int8_t Project_AFM_Controller_USB_Receive  (uint8_t* pbuf, uint32_t *Len);

USBD_CDC_ItfTypeDef USBD_CDC_Project_AFM_Controller_USB_fops = 
{
  Project_AFM_Controller_USB_Init,
  Project_AFM_Controller_USB_DeInit,
  Project_AFM_Controller_USB_Control,
  Project_AFM_Controller_USB_Receive
};
...
/**
  * @brief  Project_AFM_Controller_USB_Init
...
/**
  * @brief  Project_AFM_Controller_USB_DeInit
...
/**
  * @brief  Project_AFM_Controller_USB_Control
...
/**
  * @brief  Project_AFM_Controller_USB_Receive
  ...
  * @retval Result of the operation: USBD_OK if all operations are OK else USBD_FAIL
  */
static int8_t Project_AFM_Controller_USB_Receive(uint8_t* Buf, uint32_t *Len)
{
