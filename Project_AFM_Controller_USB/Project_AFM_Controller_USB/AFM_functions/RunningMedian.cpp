...
// 0.1.09 - 2014-11-25 float to float (support ARM)
...
{
	_size = LIMIT_MAX_MIN(size, MEDIAN_MAX_SIZE, MEDIAN_MIN_SIZE);
...
// n can be Math_Max <= half the (filled) size
