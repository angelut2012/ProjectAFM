...
// optical , AFM V2
#define SCANNER_RANGE_Z_NM (12.50465*1000.0/2.0)//10.98
#define SCANNER_RANGE_X_NM (83.717*1000.0/2.0)
#define SCANNER_RANGE_Y_NM (70.532*1000.0/2.0)
...
#define EPS (0.000001)
#define MAX_STEP_SIZE_PIEZO_MODEL_NM (100)//50.0 20// tuning fork(2.0)//(4.0)
