...
% fn='Image_ADC_no_Tcomp5_HL20160715002307.txt'
ind=find(fn=='_')
ind=ind(end);
fnT=fn;
fnT([ind+1 ind+2])='Tz'
% fnT='Image_ADC_no_Tcomp5_Tz20160715002307.txt'
...
load cfSurf_z.mat  
% (Vscsg, temp, motion)
imc=feval(cfSurf_z,imraw,imt).*10980.*4.5;

imc=imc-min(imc(:));

figure(11)
surf(imc,'LineStyle','non')
colorbar
zlabel('nm')
% return
...
% im_flat=image_adjust_plane2(imraw,1,2,px,py);%
