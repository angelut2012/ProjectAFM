...
//#define MAX_STEPS_PIEZO_MODEL (3) //(1000.0/85/3)// each time use=85us, 3 axes, Math_Max steps=3
...
//		if (Math_Abs(deltaPosition)>max_step_size)
//			if (deltaPosition>0)
//			{
...
//			//double H_now = H_now;
//			//H_now = H_now.^n;
//			double dH = (alpha/dp*deltaPosition - beta*H_now[axis]*deltaPosition*SIGN(deltaPosition) - gamma*Math_Abs(H_now[axis])*deltaPosition) /
//				(1-alpha/dp+beta*H_now[axis]*SIGN(deltaPosition)+gamma*Math_Abs(H_now[axis]) );
...
//			mAFM_DAC.DAC_write(axis, value_dac[axis]);
//
//
//			//Serial.print("value_dac[axis] ");
//			//Serial.println(value_dac[axis],DEC);
//			//
//			//Serial.print("deltaPosition ");
//			//Serial.println(deltaPosition,DEC);
//			//fastDigitalWrite(23,false);
//	}
//	while (Math_Abs(deltaPosition)>max_step_size);
//
//	return value_dac[axis];
//}
