...
////////////////////////////////
#define PADC0   (23)	//(24) //DAC SS on pin 28

#define PADC1   (25)
#define PADC2   (26)
#define PADC3   (27)
#define PADC4   (24)// on maainboard
#define PADC_5  (55)//SPI_CS on Pin3x2 port

// new define wirng
//#define ADC_PORT_X (0) not connected
#define ADC_PORT_Y (1)
#define ADC_PORT_Z (2)
#define ADC_CHANNEL_PRC (3)// on AFM

#define ADC_PORT_TUNING_FORK (4)// on mainboard
#define ADC_PORT_3x2 (5)// on mainboard

#define NUM_OF_ADC (6)
const int padc[NUM_OF_ADC] = {PADC0,PADC1, PADC2, PADC3,PADC4,PADC_5};

// select z sensor
//#define ADC_PORT_ZlOOP_SENSOR ADC_CHANNEL_PRC
...
//ADC_read_DAC_write is not used anymore
void ADC_read_DAC_write(byte ADC_channel, uint32_t * pADC_value,byte DAC_channel, uint32_t DAC_value) // long, unsigned int is 4 bytes
{
	...
	//if(ADC_channel==ADC_CHANNEL_PRC)// for PRC adc16, set last 2 zero
